...
/**
 * check97 - checks for the correct
 * number of arguments
...
/**
 * check99 -  checks whether a file called
 * file_to can be written to.
 * @check: checks if true of false
 * @file: file_to name
 * @fd_from: File descriptor
 * of file_from, or -1
...
/**
 * check100 - Verifies whether file
 * descriptors were closed properly.
